  ...
  return (
    <div className={styles.paper}>
      ...
      <P>
        ...
        play around with this 2x2 puzzle. You'll be able to visit all possible
      ...
      <P>
        ...
        graph of the 2x2 puzzle out of the water.
      </P>
      ...
      <P>
        ...
        peculiar about the size of the graph generated by the 2x2 puzzle. Before
        the restrictions of a sliding puzzle are taken into account, it may come
        across as obvious that the number of nodes in the graph should the same
        as the number of possible 4-digit permutations. Then the number of
        possible board states should be
      ...
      <P>
        ...
        is a standard square 3x3 puzzle with indices included:
      </P>
      ...
      <P>
        ...
        in each sliding puzzle. In the 5x5 puzzle below, each cycle is assigned
      ...
      <P>
        ...
        learned earlier, in a 5x5 sliding puzzle there are{" "}
        ...
        number of states in a 5x5 sliding puzzle is so large that no algorithm
        has yet discovered the number of moves that are required in the worst
        case.
      </P>
